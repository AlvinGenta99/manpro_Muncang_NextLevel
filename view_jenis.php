...
<head>
 <h1><center>Daftar Jenis<center></h1>
</head>
...
<br>
  ...
  <?php
    ...
    $result = pg_query("SELECT * FROM jenis ORDER BY id_jenis ASC");
    ...
    {
        $query = pg_query("SELECT * FROM jenis LIMIT $halaman OFFSET $mulai") or die(error);
    }
