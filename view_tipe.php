...
<br>
  ...
  <?php
    ...
    $result = pg_query("SELECT * FROM tipe ORDER BY id_tipe ASC");
    ...
    {
        $query = pg_query("SELECT * FROM tipe LIMIT $halaman OFFSET $mulai") or die(error);
    }
