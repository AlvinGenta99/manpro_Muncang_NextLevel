<?php
/**
 * Main function to insert data into the DB
 * 
...
$newRecycleId = pg_query("SELECT a.id_tipe, a.nama_tipe FROM tipe a LEFT JOIN recycle_identifier b ON a.id_tipe = b.id_tipe WHERE b.id_recycle IS NULL;");
 ...
 <div class="tab-content">
  <div id="home_menu" class="container tab-pane active"><br>
            <form class="text-center" action="insert_barang.php" method='post'>
                ...
                <input name = "spStock" pattern="[0-9]" type="number" class="form-control mb-3 col-5" placeholder="Stock Awal...">
                </div>
                </center>
                ...
                <input name = "spHarga" pattern="[0-9]" type="number" class="form-control mb-3 col-5" placeholder="Harga Jual...">
                </div>
                </center>
    ...
    <center><h4>Tambah Recycle ID Baru Untuk Sparepart<h4></center><br>
      ...
      <center>
        <div class="md-form">
          ...
          <?php 
            ...
            while ($rowt = pg_fetch_array($newRecycleId)) 
            {
              echo "<option value='" . $rowt['id_tipe'] . "'>" . $rowt['nama_tipe'] . "</option>";
            }  
            echo "</select>"; 
      ...
      <center>
          <div class="md-form">
            ...
            <input name = "iRecycleCount" pattern="[0-9]" type="number" class="form-control mb-3 col-5" placeholder="Recycle Count">
          </div>
         </center>
  ...
  <div id="update_stock" class="container tab-pane fade"><br>
        <center><h4>Masukkan ID barang dan stock yang ingin ditambah<h4><center><br>
            ...
            <center>
                ...
                <input name = "iStock_update" pattern="[0-9]" type="number" class="form-control mb-3 col-5" placeholder="Jumlah Barang Baru">
                </div>
            </center>
