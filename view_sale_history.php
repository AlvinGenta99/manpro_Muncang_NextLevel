...
<head>
    ...
    <title>Lihat Riwayat Sales</title>
	  ...
	  <div class"col">
		  <form class="dropdown" id="right-panel-link" action="test_filter.php" method="post">
					<select class="form-control" name="dd_opt">
                        ...
                        <option value="total">Pendapatan</option>
...
<br>
  ...
  <?php
    ...
    $result = pg_query("SELECT * FROM view_jual");
    ...
    {
        $query = pg_query("select * from view_jual LIMIT $halaman OFFSET $mulai") or die(error);
    }
